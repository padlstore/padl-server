...
* `/offers`
  * Type: `GET`
  * Body parameters: None
  * Returns a JSON of all the offers in the database; obsoleted by Algolia.
  * Returns:
    * `200`
...
* `/offers/:offer_id`
  * Type: `GET`
  * Body parameters: None
  * Returns a JSON with information about a specific offer; obsoleted by Algolia.
  * Returns:
    * `200`
...
* `/offers/:offer_id/cancel_offer`
  * Type: `POST`
  * Body parameters: None
  * Releases the lock a user has on an offer when they decide they no longer want the offer.
  * Not currently implemented.
  * Returns:
    * `200`

* `/offers/:offer_id/purchase`
  * Type: `POST`
  * Body parameters: None
  * Locks an offer 
  * Returns:
...
* `/offers/:offer_id/charge`
  * Type: `POST`
  * Body parameters:
    * `source`: The token generated by Stripe that is used to charge an account.
  * Creates a Stripe charge on an Express user account using the provided token.
  * Returns: 
    * `200`

* `/offers/:offer_id/buyer_sign_contract`
  * Type: `POST`
  * Body parameters: None
  * 
  * Returns:
...
* `/offers/:offer_id/seller_sign_contract`
  * Type: `POST`
  * Body parameters: None
  * 
  * Returns:
...
* `/offers/:offer_id/cancel_purchase`
  * Type: `POST`
  * Body parameters: None
  * 
  * Returns:
